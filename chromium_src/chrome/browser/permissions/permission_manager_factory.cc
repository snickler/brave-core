...
#define BRAVE_PERMISSION_MANAGER_FACTORY_BUILD_SERVICE_INSTANCE_FOR \
  BraveCreatePermissionContexts(profile)
...
#undef BRAVE_PERMISSION_MANAGER_FACTORY_BUILD_SERVICE_INSTANCE_FOR
