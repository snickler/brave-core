...
#ifndef COMPONENTS_OMNIBOX_BROWSER_SUGGESTED_SITES_PROVIDER_H_
#define COMPONENTS_OMNIBOX_BROWSER_SUGGESTED_SITES_PROVIDER_H_
...
#endif  // COMPONENTS_OMNIBOX_BROWSER_SUGGESTED_SITES_PROVIDER_H_
